...
public final class Config {
    ...
    public static final double CATEGORY_NAME_ET_WIDTH_PERCENT = 27.0 / 100;
    public static final double CATEGORY_VALUE_ET_WIDTH_PERCENT = 14.0 / 100;
    public static final double CONST_PAYMENT_CB_WIDTH_PERCENT = 14.0 / 100;
    public static final double SHOP_ET_WIDTH_PERCENT = 23.0 / 100;
    public static final double OPTIONAL_DAYS_SPINNER_WIDTH_PERCENT = 22.0 / 100;

    public static final double CATEGORY_NAME_TV_TITLE_WIDTH_PERCENT = 27.0 / 100;
    public static final double CATEGORY_VALUE_TV_TITLE_WIDTH_PERCENT = 17.0 / 100;
    public static final double CONST_PAYMENT_TV_TITLE_WIDTH_PERCENT = 12.0 / 100;
    public static final double SHOP_TV_TITLE_WIDTH_PERCENT = 22.0 / 100;
    public static final double PAY_DATE_TITLE_WIDTH_PERCENT = 22.0 / 100;

    public static final Set<String> shopsSet = new TreeSet<>();
    public static final ArrayList<String> LOG_REPORT = new ArrayList<>();
